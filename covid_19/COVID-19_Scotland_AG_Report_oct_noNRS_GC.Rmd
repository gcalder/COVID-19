...
fig1_inset <- ggplot(wk_gr_newcases %>% filter(!is.na(ratio) & 
  ...
  scale_y_continuous(trans = "log10", limits = c(0.6, NA),
                     breaks = c(0.6,0.8,1,1.2),
...
fig2_inset <- ggplot(wk_gr_newdeaths_adj_mainplot %>% filter(!is.na(ratio) & 
  ...
  scale_fill_manual(values = c("grey50", nice_red)) +
    scale_y_continuous(trans = "log10", limits = c(0.4, NA),
                     breaks = c(0.6,0.8,1,1.2),
                     labels = c(0.6,0.8,1,1.2)) +
  labs( x = "",
        y = "") +
...
fig3_inset <- ggplot(wk_gr_hosp_hosp %>% filter(!is.na(ratio_m) & 
  ...
  scale_x_date(date_breaks = "7 days", labels = date_format("%b %d")) +
  scale_y_continuous(trans = "log10", limits = c(0.57, NA),
                     breaks = c(0.6,0.8,1,1.2),
                     labels = c(0.6,0.8,1,1.2)) +
  labs( x = "",
        y = "") +
...
expand = expansion(mult = 0.1)) +
  ...
  scale_color_manual(values = c("#42C0FB","#1B9E77", "#D95F02", "#7570B3", "#E7298A", "grey28", "#E6AB02", "#A6761D")) +
  labs( x = "End Date of Current Week",
        y = "Weekly Ratio",
        #title = "Change in weekly cases/deaths total as ratio of previous week",
        subtitle = "New Cases (Source: PHS)") +
...
figX_inset <- ggplot(wk_gr_newcases_agr_plt%>% filter(!is.na(ratio_m) & !is.infinite(ratio) & date >= max(wk_gr_newcases_agr_plt$date)-20)) +
  ...
  geom_point( size = 1) +
  scale_x_date(date_breaks = "1 week", labels = date_format("%b %d")) +
  scale_y_continuous(trans = "log10",limits = c(0.5,1.6),breaks = c(0.6,0.8,1,1.3,1.6),
  expand = expansion(mult = 0.1)) +
  scale_color_manual(values = c("#42C0FB","#1B9E77", "#D95F02", "#7570B3", "#E7298A", "grey28", "#E6AB02", "#A6761D")) +
  labs(x = "", y = "") +
  theme_bw(base_size = 10) + 
