...
date: "`r format(Sys.time()-86400, '%d %B, %Y')`" 
output: pdf_document
urlcolor: blue
---
...
fig2 <- ggplot(gr_newdeaths) +
  ...
  scale_y_continuous(expand = c(0.1, 0), #breaks = c(-0.1, 0, 0.1, 0.2, 0.3, 0.4, 0.6, 0.8), 
                     labels = scales::percent_format(), limits = c(-0.65, 1)
                     ) +
  labs(
    x = "End date of 7 day period",
    y = "Daily % growth",
