...
def construct_email_contents_text(human_readable_datetime, death_totals, test_totals):
    """
    Construct human readable email text based on calculated figures
    """
    ...
    return(
        ...
        Hello,
        \n\n
        Here is the daily report for COVID - 19 in Scotland for {human_readable_datetime}{death_totals}{test_totals}.
        \n\n
        Please find the raw data and graphs for cases, deaths and per capita metrics attached. 
        To enhance graph readability and to account for cases being reallocated across health boards, 
        the following health boards are grouped together: Grampian, Shetland and Orkney; Highland and Western Isles. 
        \n \n
        Please note that this is an automated service. For any queries, please contact g.calder@ed.ac.uk. 
        \n\n
        The data in this report are provided by Health Protection Scotland and published daily by the 
        Scottish Government here https://www.gov.scot/coronavirus-covid-19/
        \n\n
        Thank you."
        """
    )
...
new_prop_cycle = cycler(
    "color", [
        ...
        "#e377c2", "#7f7f7f", "#bcbd22", "#17becf", "#FFD700", "#000000"
    ]
)
...
df_7 = df_7.replace("\*", "", regex=True)  # noqa
...
txt_5 = """
            The death toll is currently {}.\nThe number of new deaths reported today was {}, which represents a {}% 
            increase on yesterday.
        """.format(total_deaths, new_deaths, m)
...
fig.savefig(r"filepath\Daily_Reports\COVID-19_Scotland_casesDeaths_Plot_{}.png".format(
    tDt), dpi=400, bbox_inches="tight"
)
# fig.show()
...
txt_1 = """
            The total number of cases is currently {}.\nThe number of new cases today is {}, which represents a {}% 
            crease on yesterday.
        """.format(yb, z, p2)
...
txt_2 = """
            ...
            The percentage of tests which were positive is currently {}%.
        """.format(tot, y, pos)
...
txt_4 = """
            The largest increase in cases in absolute terms by health board was {} cases, which occurred in {}.\n
            The largest relative increase in cases was {}%, which occurred in {}.
        """.format(Inc_max, Inc_maxLoc, pInc_max2, pInc_maxLoc)
...
txt_6 = """
            The highest incidence over the last day was {}, which occurred in {}. 
            \nThe highest cumulative incidence is {}, which is in {}.
        """.format(incdMax, incdMaxLoc, prevMax, prevMaxLoc)
...
df_Deaths_XTran.to_excel(
    r"filepath\Daily_Reports\SARS-Cov-2-Scotland-{}_deaths_trans.xlsx".format(tDt), sheet_name="Deaths"
)
...
fig2.savefig(
    r"filepath\Daily_Reports\COVID-19_Scotland_CasesHealthBoard_Plot_{}.png".format(tDt), dpi=400, bbox_inches="tight"
)
...
# No need to combine health boards as already done upstream
...
fig3.savefig(
    r"filepath\Daily_Reports\COVID-19_Scotland_cumIncidence_timeSeries_Plot_{}.png".format(tDt),
...
fig4.savefig(
    r"filepath\Daily_Reports\COVID-19_Scotland_cumIncidence_BarChart_{}.png".format(tDt), dpi=400, bbox_inches="tight"
)
...
# TODO: Remember to make these variable names meaningful (and consistent with the method here definition)
txt_omni = construct_email_contents_text(tDt_human, txt_all, txt_2)
print(txt_omni)
...
fig5.savefig(
    (r"C:\Users\gcalder2\Daily_Reports\COVID-19_Scotland_CPT_Plot_{}.png".format(tDt)), dpi=400, bbox_inches="tight"
)
...
df_CPT_x.to_excel(
    (r"C:\Users\gcalder2\Daily_Reports\COVID-19_Scotland_CPT_DPC_{}.xlsx".format(tDt)), sheet_name="CPT & DPC"
)
