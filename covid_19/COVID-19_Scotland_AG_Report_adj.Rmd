...
```{r cases, fig.width=8, fig.height = 9, fig.cap="Daily cases and 7-day rolling sums by health board. Numbers are published as cumulative cases and only shown when higher than 4, making the first entry for each health board artificially high."}
ymax <- 3  
hb_cases %>% 
...
```{r fig.height=6.5, fig.width=10, fig.cap="Weekly and day-of-the-week ratios over the last 3 weeks by health board"}
...
fig <- annotate_figure(fig,
               ...
               bottom = stringr::str_glue("Figure 12.", {which(sort(health_boards)==i)},":"," Weekly ratios for new cases & new deaths and day-of-the-week ratios for patients in hospital & ICU \nfor ", {i} ," with other health boards shown in grey.", " Figure insets highlight ratios and trends for the last 21 days. \n* denotes ratios where there has been at least one case in the past week but none in the previous week."))
print(fig)
cat('\r\n\r\n')
