...
render("COVID-19_Scotland_Daily_Update_gr.Rmd", 
       output_file = str_glue("COVID-19-Scotland-Daily-Update-", {str_replace_all(Sys.Date()-1, pattern = "-", "-")}, ".html"))

#PDF report
render("COVID-19_Scotland_Daily_Update_pdf_gr.Rmd", 
       output_file = str_glue("COVID-19-Scotland-Daily-Update-", {str_replace_all(Sys.Date()-1, pattern = "-", "-")}, ".pdf"))
...
#Word report
file_name_word <- str_glue("COVID-19-Scotland-Daily-Update-", {str_replace_all(Sys.Date()-1, pattern = "-", "-")}, ".docx")
...
rmarkdown::pandoc_convert(input = str_glue("COVID-19-Scotland-Daily-Update-", {str_replace_all(Sys.Date()-1, pattern = "-", "-")}, ".docx"), to="html", output = str_glue("COVID-19-Scotland-Daily-Update-", {str_replace_all(Sys.Date()-1, pattern = "-", "-")}, ".txt"))
